...
public class CommentAdapter extends RecyclerView.Adapter<CommentAdapter.ItemHolder> {
    ...
    public CommentAdapter(List<Review> dataReView) {
    ...
    public class ItemHolder extends RecyclerView.ViewHolder {
        ...
        public ItemHolder(@NonNull View itemView) {
            super(itemView);
            txtName = itemView.findViewById(R.id.username_in_open_book_comment);
            txtReview = itemView.findViewById(R.id.comment_in_open_book);
        }
    }
}
